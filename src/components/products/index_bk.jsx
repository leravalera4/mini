...
const Products = ({ cartData }) => {
  ...
  return (
    <div>
      <div style={{ marginLeft: "80px", marginRight: "80px", paddingBottom: "385px" }}>
        <div>
          <Tour />
        </div>
        <h1
        ...
        <div>
          <div style={{width:'330px'}} className="select-store">
            <label
              style={{
                paddingRight: "8px",
                fontSize: "18px",
...
<div style={{ marginLeft: "80px", marginRight: "80px",height:'766px' }}>
<h1
  style={{
    textAlign: "center",
    paddingBottom: "0px",
  ...
  <div style={{ display: "flex", paddingLeft: "24px" }}>
    ...
    {selectedLocation && (
      <button
        ...
        //disabled={selectedLocation === null && selectedAll.includes(selectedLocation)}
        disabled={
          selectedAll.some(
  ...
  {selectedAll.length > 0 && (
    <div onKeyDown={handleKeyDown} tabIndex="0">
      ...
      //  disabled={!searchText || !selectedLocation || selectedAllLength && selectedAllLength.length === 0}
        disabled={!searchText || selectedAllLength && selectedAllLength.length === 0}
      >
        Search
      </button>
    </div>
